                ...
                <div class="col-lg-4 col-md-12">
                    <aside class="widget-area">
                        ...
                        <div class="widget widget_grin_posts_thumb">
                            ...
                            <article class="item">
                                <a href="services-details.php" class="thumb">
                                    <span class="fullimage cover bg1" role="img"></span>
                                </a>
                                <div class="info">
                                    <span>November 27, 2022</span>
                                    <h4 class="title usmall">
                                        <a href="services-details.php">New Technology Make for Dental Operation</a>
                                    </h4>
                                </div>
                            </article>
                            <article class="item">
                                ...
                                <div class="info">
                                    <span>November 27, 2022</span>
                                    <h4 class="title usmall">
                                        <a href="services-details.php">Regular Dental care make Your Smile Brighter</a>
                                    </h4>
                                </div>
                            </article>
                            <article class="item">
                                ...
                                <div class="info">
                                    <span>November 27, 2022</span>
                                    <h4 class="title usmall">
                                        <a href="services-details.php">Dental Hygiene for All Age to Make Smile</a>
                                    </h4>
                                </div>
                            </article>
                        </div>
...
<!-- Mirrored from templates.hibootstrap.com/grin/default/services-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 12:02:35 GMT -->
