...
<!-- Mirrored from templates.hibootstrap.com/grin/default/blog-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 12:02:40 GMT -->
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="blog-details-desc">
                        <div class="article-image">
                            ...
                            <div class="tag-two"><a href="blog-details.php">Technology</a></div>
                        </div>
                        <div class="article-content">
                            <div class="entry-meta">
                                <ul>
                                    ...
                                    <li>
                                        <span>Posted By:</span>
                                        <a href="blog-details.php">John Anderson</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <blockquote class="wp-block-quote">
                                <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor.</p>
                            </blockquote>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                            ...
                            <ol class="comment-list">
                                <li class="comment">
                                    <div class="comment-body">
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img src="assets/images/doctor/doctor-1.jpg" class="avatar" alt="image">
                                        ...
                                        <div class="reply">
                                            <a href="blog-details.php" class="comment-reply-link">Reply</a>
                                        </div>
                                    </div>
                                    <ol class="children">
                                        <li class="comment">
                                            <div class="comment-body">
                                                <footer class="comment-meta">
                                                    <div class="comment-author vcard">
                                                        <img src="assets/images/doctor/doctor-2.jpg" class="avatar" alt="image">
                                    ...
                                    <div class="comment-body">
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img src="assets/images/doctor/doctor-3.jpg" class="avatar" alt="image">
                ...
                <div class="col-lg-4 col-md-12">
                    <aside class="widget-area">
                        ...
                        <div class="widget widget_categories">
                            ...
                            <ul>
                                <li><a href="index.php">Dental</a></li>
                                <li><a href="index.php">Medical</a></li>
                                <li><a href="index.php">Dentist</a></li>
                                <li><a href="index.php">Hygiene</a></li>
                                <li><a href="index.php">Hospital</a></li>
                                <li><a href="index.php">Child Care</a></li>
                            </ul>
                        </div>
                        <div class="widget widget_tag_cloud">
                            ...
                            <div class="tagcloud">
                                ...
                                <a href="index.php">Uncategorized</a>
                            </div>
                        </div>
...
<!-- Mirrored from templates.hibootstrap.com/grin/default/blog-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 12:02:41 GMT -->
